...
/// Setter for <a href="x-source-tag://crashReporting">crashReporting</a>
/// for setting properties of Mikros Crash Reporting.
/// \param crashReporting Allow to disable/enable the Mikros Crash Reporting.
/// True by default.
///
///
/// returns:
/// <a href="x-source-tag://AnalyticsConfigurationBuilder">AnalyticsConfigurationBuilder</a>
- (AnalyticsConfigurationBuilder * _Nonnull)setWithCrashReporting:(BOOL)crashReporting SWIFT_WARN_UNUSED_RESULT;
...
/// Method used to update the value of crash Reporting, allowing to enable or disable
/// Mikros Crash Reporting  once the configuration has been set.
/// \param isEnabled Enable or disable Mikros Crash Reporting.
///
- (void)updateCrashReportingWithIsEnabled:(BOOL)isEnabled;
