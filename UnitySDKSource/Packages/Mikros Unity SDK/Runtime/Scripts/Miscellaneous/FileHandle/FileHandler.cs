...
namespace MikrosClient.FileHandle
{
    /// <summary>
    /// File handling.
    /// </summary>
    internal sealed class FileHandler
    {
        ...
        /// </summary>
        internal static string MikrosFileStorageBasePath => Path.Combine(Application.persistentDataPath, Constants.Mikros);
        ...
        internal static bool DeleteFile(string filePath)
        {
            ...
            {
                new MikrosException(ExceptionType.OTHER, ex.Message);
                return false;
            }
        }
